...
export function CardDetalhado({assuntoData, onClose}: Props) {
    ...
    return (
        <div className="w-full h-full bg-black/30 fixed inset-0 flex items-center justify-center z-50 backdrop-blur-sm" onClick={onClose}>
            <div className="w-[350px] h-[400px] bg-zinc-800 flex flex-col p-4 rounded-lg">
                ...
                <div className="w-full h-[200px] flex flex-col">
                    ...
                    <Button style="w-[100px] h-[30px] bg-red-400 mt-4" title="concluir" onClick={onClose}/>
                </div>
            </div>
        </div>
    )
