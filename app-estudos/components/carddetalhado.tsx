...
export function CardDetalhado({assuntoData, onClose}: Props) {
    ...
    return (
        <div className="w-full h-full bg-black/60 fixed inset-0 flex items-center justify-center z-50">
            <div className="w-[350px] h-[400px] bg-zinc-800 flex flex-col p-4 rounded-lg">
                <div className="w-full h-[70px] flex flex-col items-center justify-center">
                    <h2 className="w-full h-[40px] text-base flex items-center justify-center font-bold">{assuntoData.assunto}</h2> {/* 38 caracteres*/}
